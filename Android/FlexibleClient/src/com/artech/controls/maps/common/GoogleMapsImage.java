...
{
	public static String getUrl(String location, int width, int height, String mapType)
	{
		...
		final String URL_FORMAT = "https://maps.google.com/maps/api/staticmap?markers=%s&zoom=15&size=%sx%s&sensor=false&maptype=%s%s"; //$NON-NLS-1$
		return String.format(URL_FORMAT, Services.HttpService.UriEncode(location), width, height, mapType, urlExtra);
	}
}
