...
public class GxSectionLink extends GxLinearLayout
{
	...
	public void setDefinition(ContentDefinition content)
	{
		...
		TextView description= (TextView) findViewById(R.id.listViewDescription);
		LinearLayout actions= (LinearLayout) findViewById(R.id.listViewActionList);
		LinearLayout listViewTexts = (LinearLayout) findViewById(R.id.listViewTexts);
