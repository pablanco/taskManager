...
public interface IGxEdit extends IGxUserControl
{
	 ...
	 * @param value
	 */
	void setGx_Value(String value);

	/**
	 * The program use this as a memento, so return the value previously stored using setGx_Tag
	 * @return
	 */
	String getGx_Tag();

	/***
	 * Just store this memento to return in a subsequent call to getGx_Tag
	 * @param tag
	 */
	void setGx_Tag(String tag);
