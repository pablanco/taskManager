...
public interface IStringUtil
{
	...
	Date getDateTime(String dateTimeString, boolean shouldNotConvertOnlyTime);
	...
	String getDateTimeStringForServer(Date date, boolean shouldNotConvertOnlyTime);
	 ...
	 */
	int parseEnum(String value, String... options);

	Integer parseMeasureValue(String str, String unit);

	/**
	 * Returns the double value if the supplied string is a representation of a long value,
	 * and the supplied default value otherwise.
	 */
