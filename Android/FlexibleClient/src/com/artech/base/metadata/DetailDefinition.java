...
public class DetailDefinition extends DataViewDefinition
{
	...
	private final List<SectionDefinition> mSections = new ArrayList<SectionDefinition>();
	...
	public String getName()
	{
		...
		return String.format("%s.%s.%s", getPattern().getName(), mParent.getName(), "Detail"); //$NON-NLS-1$ //$NON-NLS-2$
	}
