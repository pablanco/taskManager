...
public class OrderAttributeDefinition implements Serializable
{
	...
	{
		mName = MetadataLoader.getAttributeName(jsonOrderAttribute.getString("@attribute")); //$NON-NLS-1$
		mIsAscending = jsonOrderAttribute.optBoolean("@ascending", true); //$NON-NLS-1$
	}
}
