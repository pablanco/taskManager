...
public class LevelDefinition extends DataItem
{
	...
	public List<DataItem> Items = new Vector<DataItem>();
	public List<LevelDefinition> Levels = new Vector<LevelDefinition>();
	...
	public LevelDefinition getLevel(String name)
	{
		...
		for (LevelDefinition level : Levels)
		{
			...
			if (levelName.equalsIgnoreCase(name) || Services.Strings.hasValue(levelItemName) && levelItemName.equalsIgnoreCase(name))
				return level;
		}
	...
	public void merge(LevelDefinition levelDefinition)
	{
		...
		Vector<DataItem> mergedAttributes = new Vector<DataItem>();
