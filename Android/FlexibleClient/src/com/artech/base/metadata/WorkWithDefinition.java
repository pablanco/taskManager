...
public class WorkWithDefinition implements IPatternMetadata
{
	...
	private final List<WWLevelDefinition> mLevels = new ArrayList<WWLevelDefinition>();
	...
	public StructureDefinition getBusinessComponent()
	{
		if (mBusinessComponent == null && mBCName != null)
			mBusinessComponent = Services.Application.getBusinessComponent(mBCName);
	...
	{
		List<IDataViewDefinition> dataViews = new ArrayList<IDataViewDefinition>();
