...
public class SparkLineView extends View {
	private static Float  MAX_TEXT_FRAC         = 0.5f;     // maximum fraction of view to give to the textual part
	private static Float  MARKER_MIN_SIZE       = 4.0f;     // maximum size of the anchor marker we'll use (in points)
	private static Float  DEF_MARKER_SIZE_FRAC  = 0.2f;     // default fraction of the view height we'll use for the anchor marker
	private static Float  MARKER_MAX_SIZE       = 8.0f;     // maximum size of the anchor marker we'll use (in points)
	private static Float  GRAPH_X_BORDER        = 2.0f;     // horizontal border width for the graph line (in points)
	private static Float  GRAPH_Y_BORDER        = 2.0f;     // vertical border width for the graph line (in points)
	private static Float  CONSTANT_GRAPH_BUFFER = 0.1f;     // fraction to move the graph limits when min = max
