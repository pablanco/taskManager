...
import com.artech.android.beacons.BeaconServices;
...
public class StartupBroadcastReceiver extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent startServiceIntent = new Intent(context, BeaconServices.getBeaconServiceClass());
        context.startService(startServiceIntent);
        startServiceIntent = new Intent(context, BeaconServices.getBeaconIntentProcessorClass());
        context.startService(startServiceIntent);
