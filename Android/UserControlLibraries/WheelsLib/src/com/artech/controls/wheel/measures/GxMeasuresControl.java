...
import com.artech.controls.wheel.GxWheelPicker;
...
public class GxMeasuresControl extends GxLinearLayout implements IGxEdit
{
	...
	private void setControlInfo(ControlInfo info) {
		String measureType = info.optStringProperty("@SDPhysicalMeasureMeasureType"); //$NON-NLS-1$
	...
	public String getGx_Value() {
		return mMeasuresHelper.getGx_Value(GxMeasuresHelper.mValueKey, GxMeasuresHelper.mUnitKey, GxMeasuresHelper.mConvertedValueKey);
	}
	...
	public void setGx_Value(String value) {
		...
		try {
			...
			String valueUnit = valueJSONObject.getString(GxMeasuresHelper.mUnitKey);
			double valueKey = valueJSONObject.getDouble(GxMeasuresHelper.mValueKey);
