...
public class GxWheelNumericControl implements IGxWheelControl {
	...
	public GxWheelNumericControl(ControlInfo info) {
		mInitialMaxValue = info.optStringProperty("@SDWheelMaxValue"); //$NON-NLS-1$
		mMaxValue = Float.parseFloat(mInitialMaxValue);
		mInitialMinValue = info.optStringProperty("@SDWheelMinValue"); //$NON-NLS-1$
		mMinValue = Float.parseFloat(mInitialMinValue);
		mInitialStepValue = info.optStringProperty("@SDWheelStep"); //$NON-NLS-1$
		...
		if (mInitialStepValue.contains(Strings.DOT)) {
			...
			String strInitialValue = info.optStringProperty("@SDWheelInitialValue"); //$NON-NLS-1$
			...
			mDisplayInitialValue = info.optStringProperty("@SDWheelInitialValue"); //$NON-NLS-1$
		}
