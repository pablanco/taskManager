...
public class TwitterSingleton {
	...
	private static Twitter createInstance() {
		...
		boolean isAuthorized = MyApplication.getAppSharedPreferences(TwitterApiConstants.PREFERENCES_KEY).getString(TwitterApiConstants.PREF_KEY_TOKEN, null) != null;
		if (isAuthorized) {
			String accessTokenStr = MyApplication.getAppSharedPreferences(TwitterApiConstants.PREFERENCES_KEY).getString(TwitterApiConstants.PREF_KEY_TOKEN, "");
			String accessTokenSecretStr = MyApplication.getAppSharedPreferences(TwitterApiConstants.PREFERENCES_KEY).getString(TwitterApiConstants.PREF_KEY_TOKEN_SECRET, "");
