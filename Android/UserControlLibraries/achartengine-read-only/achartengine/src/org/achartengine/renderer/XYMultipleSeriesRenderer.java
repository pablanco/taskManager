...
public class XYMultipleSeriesRenderer extends DefaultRenderer
{
  ...
  public XAlign getXAxisAlign(int scale) {
    return xAxisAlign[scale];
  }

  public void setXAxisAlign(XAlign align, int scale) {
    xAxisAlign[scale] = align;
  }
