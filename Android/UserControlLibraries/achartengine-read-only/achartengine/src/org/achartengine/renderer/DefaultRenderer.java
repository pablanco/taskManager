...
public class DefaultRenderer implements Serializable
{
  ...
  /** If the reference should be displayed. */
  private boolean mShowReference = false;
  ...
  /** The value Reference Line Position. */
  private float mReferenceLinePosition = 0;
  /**
  ...
  /**
   * Returns if the reference should be visible.
   * 
   * @return the visibility flag for the reference
   */
  public boolean isShowReference() {
    return mShowReference;
  }

  /**
   * Sets if the reference should be visible.
   * 
   * @param showReference the visibility flag for the reference
   */
  public void setShowReference(boolean showReference) {
    mShowReference = showReference;
  }
  /**
   ...
   * @return the margin sizes
   */
  public float getReferenceLinePosition() {
    return mReferenceLinePosition;
  }
   ...
   *          top, left, bottom, right
   */
  public void setReferenceLinePosition(float linePosition) {
    mReferenceLinePosition = linePosition;
  }
