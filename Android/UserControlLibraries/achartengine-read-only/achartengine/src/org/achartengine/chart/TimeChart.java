...
public class TimeChart extends LineChart
{
  ...
  protected void drawXLabels(List<Double> xLabels, Double[] xTextLabelLocations, Canvas canvas,
    ...
    if (length > 0) {
      ...
      //boolean showReference = mRenderer.isShowReference();
      ...
      for (int i = 0; i < length; i++) {
        ...
        if (showLabels) {
          ...
          if (mRenderer.getXAxisAlign(0) == XAlign.BOTTOM) {
        	  canvas
              .drawLine(xLabel, top, xLabel, top + mRenderer.getLabelsTextSize() / 3, paint);
        	  drawText(canvas, format.format(new Date(label)), xLabel, top
